...
%>
	...
	<div class="registration">
		<div class="container">
			...
			<center>	<h3>List of Properties</h3></center>
				<div class="login-form">
					
					<center>
<h1>USER DETAILS</h1>
<form action="searchListofProperties.jsp" method="post">
ENTER EMAIL ID
<input type="text" name="EMAIL" />

<input type="submit" value="Search">
</form>
<button id="myButton" class="float-left submit-button" >Delete a Property</button>

<script type="text/javascript">
    document.getElementById("myButton").onclick = function () {
        location.href = "DeleteProperty.jsp";
    };
</script>
