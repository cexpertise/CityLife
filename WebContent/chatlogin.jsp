...
<div id="wrap">
  <div id="header">
    ...
    <div id="menu">
      <ul>
        <li id="current"><a href="qa.html">Home</a></li>
        <li><a href="chatlogin.jsp">Login</a></li>
        <li><a href="chatregister.jsp">Register</a></li>
        <li><a href="ask.jsp">Ask</a></li>
        <li><a href="index.html">Citylife Homepage</a></li>
...
<div id="footer-wrap">
  <div class="footer-left">
    <p class="align-left"> &copy; 2006 <strong> citylife.delhi@gmail.com </strong></p>
  </div>
