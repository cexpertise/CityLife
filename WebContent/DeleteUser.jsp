...
%>
	...
	<div class="registration">
		<div class="container">
			...
			<center>	<h3>Delete City Life Users</h3></center>
...
<table border=1><center>
  ...
  <th>SELECT</th>
    ...
    <center>
    <tr>
        <td><input type="checkbox" name="client" value="<%=rs.getString(3)%>" /></td>
        <td><img  src="profilePic/<%=rs.getString(12) %>" height="50" width="50" /></td>
