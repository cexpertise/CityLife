...
ResultSet resultSet=obj.getAllCabUsers();
%>
	...
	<div class="registration">
		<div class="container">
			...
			<center>	<h3>Delete Cab Users</h3></center>
				<div class="login-form">
					
					<center>
<h1>USER DETAILS</h1>
<form method="post" action="DeleteCabUserServlet">
...
<td><b>Email</b></td>
    ...
    <center>
    <tr>
        <td><input type="checkbox" name="client" value="<%=resultSet.getString(8)%>" /></td>
