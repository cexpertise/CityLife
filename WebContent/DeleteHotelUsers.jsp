...
ResultSet rs=obj.getAllHotelUsers();
%>
	...
	<div class="registration">
		<div class="container">
			...
			<center>	<h3>Delete Hotel Users</h3></center>
				<div class="login-form">
					
					<center>
<h1>USER DETAILS</h1>
<form method="post" action="DeleteHotelUserServlet">
<table border=1><center>
  <tr>	<th>CHECK</th>
    ...
    <center>
    <tr>
        <td><input type="checkbox" name="client" value="<%=rs.getString(8)%>" /></td>
        <td><img  src="profilePic/<%=rs.getString(9) %>" height="50" width="50" /></td>
