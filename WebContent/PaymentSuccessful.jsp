...
{	String cardnumber=null;
	...
	System.out.println("******************Payment Successful"+email);
	cardnumber=request.getParameter("var");
	System.out.println("******************Payment Successful"+cardnumber);
	NetmallDao n=new NetmallDao();
	ResultSet rs1=n.GetTransactionID(cardnumber);
...
<h1><font color=red>PAYMENT of Rs.<%=rs1.getString(5)%>SUCCESSFUL !</font></h1>
<h2><font color=red>Your transaction id is:<%=rs1.getString(4)%></font></h2>
</center>
<%}}
else 
{
