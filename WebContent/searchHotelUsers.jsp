...
%>
	...
	<div class="registration">
		<div class="container">
			...
			<center>	<h3>Hotel Users</h3></center>
				<div class="login-form">
					
					<center>
<h1>USER DETAILS</h1>
<form action="searchHotelUsers.jsp" method="post">
ENTER EMAIL ID
<input type="text" name="EMAIL" id="EMAIL" value=""/>

<input type="submit" value="Search">
</form>
<button id="myButton" class="float-left submit-button" >Delete Hotel Users</button>

<script type="text/javascript">
    document.getElementById("myButton").onclick = function () {
        location.href = "DeleteHotelUsers.jsp";
    };
</script>
...
{response.sendRedirect("searchHotelUsers.jsp");
}
