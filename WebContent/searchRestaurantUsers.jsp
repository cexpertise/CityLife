...
%>
	...
	<div class="registration">
		<div class="container">
			...
			<center>	<h3>Restaurant reservations</h3></center>
				<div class="login-form">
					
					<center>
<h1>USER DETAILS</h1>
<form action="searchRestaurantUsers.jsp" method="post">
ENTER EMAIL ID
<input type="text" name="EMAIL" id="EMAIL" value=""/>

<input type="submit" value="Search">
</form>
<button id="myButton" class="float-left submit-button" >Delete Restaurant Users</button>

<script type="text/javascript">
    document.getElementById("myButton").onclick = function () {
        location.href = "DeleteRestaurantUsers.jsp";
    };
</script>
...
{response.sendRedirect("searchRestaurantUsers.jsp");
}
