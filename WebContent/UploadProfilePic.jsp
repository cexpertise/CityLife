...
<body class="size-1140">
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="nav navbar-nav">
								<li class="active-item"><a href="UserHome.jsp" class="hvr-sweep-to-bottom">Home</a></li>
	...
	<div class="about-heading">
		<h2>User: <span>Upload Profile Pic</span></h2>
	</div>
			...
			<div class="signin-form profile">
				...
				<% 
					if(session.getAttribute("EMAIL")!=null)
					{
						...
						// fetching user pic from db based on session
						String sql="select pic from register where email=?";
						CityLifeDao obj=new CityLifeDao();
						ResultSet rs=obj.getUserPic(sql, Email);
						
						while(rs.next())
						{
							mypic=rs.getString(1);
				...
				%>
					...
					<div style="width:500px; height:100px; border-style: ridge;">
						<div style="height:100px; width: 100px; background-color: 8CFF00; float: left;">
						   <img src="profilePic/<%=mypic %>" height="100" width="100" />
						</div>
						<form ENCTYPE="multipart/form-data" action="UploadImageServlet"  METHOD=POST style="margin-top:50px;">
