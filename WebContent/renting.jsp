      ...
      <nav>
        <ul class="menu">
         <li><a href="index-userbuysell.html">Home</a></li>
          ...
          <li class="current"><a href="renting.jsp">Renting</a></li>
        </ul>
      </nav>
    </div>
  </header>
...
%>
      ...
      <div >
         <center><h2 class="top-1 p3">Rent a living</h2></center>
       <div >
        <div class="left-1">
          ...
          <form id="form-1" class="form-1 bot-2" action="RentPropServlet" method="post">
					...
					<h3><b><font color="#8CFF00">Land Details:</font></b></h3>
						...
						<table>
						 <tr><td> <label><pre>Owner			</pre></label></td>
				             ...
				             <td><input type="text" name="uemail" placeholder="(please enter the mail you used to login)" required=""></td>
				             </tr>
				             <tr><td>For</td>
				             <td> <select name="rentsell" >
				                <option>Rent</option>
				                <option>PG</option>
				              </select></td>
				              </tr>
...
<%
	...
	response.sendRedirect("LoginRent.jsp");
}
