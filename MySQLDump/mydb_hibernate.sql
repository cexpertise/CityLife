...
CREATE TABLE `hibernate` (
  ...
  `visitingdate` varchar(45) DEFAULT NULL,
...
LOCK TABLES `hibernate` WRITE;
/*!40000 ALTER TABLE `hibernate` DISABLE KEYS */;
INSERT INTO `hibernate` VALUES (2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `hibernate` ENABLE KEYS */;
UNLOCK TABLES;
