 ...
 */
public class CancelRestaurantBookingServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CancelRestaurantBookingServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql="delete from hibernate where email=?";
		...
		{
			response.sendRedirect("BookingCancelled2.jsp");
		}
