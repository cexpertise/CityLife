...
/**
 * Servlet implementation class RentPropServlet
 */
@WebServlet("/RentPropServlet")
public class RentPropServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RentPropServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			response.sendRedirect("renting.jsp?var=Something Happened!!! Coudn't Add Property.. Please Try Again");
		}
